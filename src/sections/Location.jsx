    ...
    <section id="Location" className="max-w-full flex flex-col items-center bg-white">
      ...
      <div className="w-full flex flex-col md:flex-row items-center py-7 md:py-14 gap-6 md:gap-14">
        ...
        <div className="flex flex-col items-center md:items-start w-full px-6 md:pl-[7.5rem] md:justify-between gap-6 text-center md:text-left lg:max-w-lg"> 
            ...
            <div className='flex flex-col items-center md:items-start w-full lg:px-2 gap-3 md:gap-6 '>
              ...
              <div className="flex items-center justify-center md:justify-start">
                ...
                <p className="text-xs md:text-xl font-body font-medium">
                 Dommasandra, Sarjapura
                </p>
              </div>
            </div>

            <ol className='text-left font-body text-xs md:text-base list-disc font-medium pl-1 md:pl-5 hidden sm:block space-y-3'>
                <li className=''>Outer Ring Road – 8 Mins</li>
                <li className=''>Sarjapur Road – 8 Mins</li>
                <li className=''>Kempegowda International Airport – 50 Mins</li>
                <li className=''>Varthur Road – 8 Mins</li>
                <li className=''>Hosa Road Metro Station – 35 Mins</li>
          ...
          <div className="text-center md:text-left w-fit">
            <Button 
              ...
              onClick={() => window.open("https://maps.app.goo.gl/MbGpaVE3qfrnZuo3A", "_blank")} // Opens Google Maps link in a new tab
            />
          </div>
        </div>
              {/* Google Maps Iframe */}
        <div className="w-full flex justify-center">
          ...
          <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3889.494459702173!2d77.75883962507481!3d12.875895387430713!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bae730046476707%3A0xcd3a5f0da961083!2sLodha%20sarjapur%20new%20project!5e0!3m2!1sen!2sin!4v1762235043603!5m2!1sen!2sin"
