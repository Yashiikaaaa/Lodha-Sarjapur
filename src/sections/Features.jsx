...
export const Features = () => {
  ...
  const featuresData = [
    { id: 1, title: 'Project Size', value: '19 Acres' },
    { id: 2, title: 'Possession', value: 'Dec 2029 ' },
    { id: 3, title: 'Starting Price', value: 'Rs 1.85 Cr*' },
    { id: 4, title: 'Units', value: '3 & 3.5 BHK' },
  ];

  return (
    <section className="w-full bg-PrestigeGrey">
      <div className="bg-[#210C01] text-PrestigeGrey w-full transform -translate-y-1/2">
